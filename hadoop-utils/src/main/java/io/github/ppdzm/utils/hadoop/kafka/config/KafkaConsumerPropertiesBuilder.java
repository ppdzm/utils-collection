 ...
 */
public class KafkaConsumerPropertiesBuilder extends PropertiesBuilder<ConsumerConfig> {

    public static KafkaConsumerPropertiesBuilder builder() {
        return new KafkaConsumerPropertiesBuilder();
    }
     ...
     *
     * @param value 值
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder AUTO_COMMIT_INTERVAL_MS(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder AUTO_OFFSET_RESET(OffsetResetStrategy strategy) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder BOOTSTRAP_SERVERS(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder CHECK_CRCS(Object value) {
        properties.put(CHECK_CRCS_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder CLIENT_ID(Object value) {
        properties.put(CLIENT_ID_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder CONNECTIONS_MAX_IDLE_MS(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder DEFAULT_API_TIMEOUT_MS(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder ENABLE_AUTO_COMMIT(boolean value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder EXCLUDE_INTERNAL_TOPICS(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder FETCH_MAX_BYTES(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder FETCH_MAX_WAIT_MS(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder FETCH_MIN_BYTES(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder GROUP_ID(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder HEARTBEAT_INTERVAL_MS(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder INTERCEPTOR_CLASSES(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder ISOLATION_LEVEL(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder KEY_DESERIALIZER_CLASS(String cls) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder MAX_PARTITION_FETCH_BYTES(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder MAX_POLL_INTERVAL_MS(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder MAX_POLL_RECORDS(Object value) {
        properties.put(MAX_POLL_RECORDS_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder METADATA_MAX_AGE(Object value) {
        properties.put(METADATA_MAX_AGE_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder METRICS_NUM_SAMPLES(Object value) {
        properties.put(METRICS_NUM_SAMPLES_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder METRICS_RECORDING_LEVEL(Object value) {
        properties.put(METRICS_RECORDING_LEVEL_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder METRICS_SAMPLE_WINDOW_MS(Object value) {
        properties.put(METRICS_SAMPLE_WINDOW_MS_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder METRIC_REPORTER_CLASSES(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder PARTITION_ASSIGNMENT_STRATEGY(Object value) {
        properties.put(PARTITION_ASSIGNMENT_STRATEGY_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder RECEIVE_BUFFER(Object value) {
        properties.put(RECEIVE_BUFFER_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder RECONNECT_BACKOFF_MAX_MS(Object value) {
        properties.put(RECONNECT_BACKOFF_MAX_MS_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder RECONNECT_BACKOFF_MS(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder REQUEST_TIMEOUT_MS(Object value) {
        properties.put(REQUEST_TIMEOUT_MS_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder RETRY_BACKOFF_MS(Object value) {
        properties.put(RETRY_BACKOFF_MS_CONFIG, value);
        return this;
    }

    public KafkaConsumerPropertiesBuilder SEND_BUFFER(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder SESSION_TIMEOUT_MS(Object value) {
     ...
     * @return {@link KafkaConsumerPropertiesBuilder}
     */
    public KafkaConsumerPropertiesBuilder VALUE_DESERIALIZER_CLASS(String cls) {
