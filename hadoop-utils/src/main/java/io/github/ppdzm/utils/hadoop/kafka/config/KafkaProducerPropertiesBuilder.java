 ...
 */
public class KafkaProducerPropertiesBuilder extends PropertiesBuilder<ProducerConfig> {

    public static KafkaProducerPropertiesBuilder builder() {
        return new KafkaProducerPropertiesBuilder();
    }
     ...
     *
     * @param value 值
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder ACKS(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder BATCH_SIZE(int value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder BOOTSTRAP_SERVERS(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder BUFFER_MEMORY(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder CLIENT_ID(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder COMPRESSION_TYPE(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder CONNECTIONS_MAX_IDLE_MS(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder ENABLE_IDEMPOTENCE(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder INTERCEPTOR_CLASSES(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder KEY_SERIALIZER_CLASS(String cls) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder LINGER_MS(int value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder MAX_BLOCK_MS(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder MAX_REQUEST_SIZE(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder METADATA_MAX_AGE(Object value) {
        properties.put(METADATA_MAX_AGE_CONFIG, value);
        return this;
    }

    public KafkaProducerPropertiesBuilder METRICS_NUM_SAMPLES(Object value) {
        properties.put(METRICS_NUM_SAMPLES_CONFIG, value);
        return this;
    }

    public KafkaProducerPropertiesBuilder METRICS_RECORDING_LEVEL(Object value) {
        properties.put(METRICS_RECORDING_LEVEL_CONFIG, value);
        return this;
    }

    public KafkaProducerPropertiesBuilder METRICS_SAMPLE_WINDOW_MS(Object value) {
        properties.put(METRICS_SAMPLE_WINDOW_MS_CONFIG, value);
        return this;
    }

    public KafkaProducerPropertiesBuilder METRIC_REPORTER_CLASSES(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder PARTITIONER_CLASS(Object value) {
        properties.put(PARTITIONER_CLASS_CONFIG, value);
        return this;
    }

    public KafkaProducerPropertiesBuilder RECEIVE_BUFFER(Object value) {
        properties.put(RECEIVE_BUFFER_CONFIG, value);
        return this;
    }

    public KafkaProducerPropertiesBuilder RECONNECT_BACKOFF_MAX_MS(Object value) {
        properties.put(RECONNECT_BACKOFF_MAX_MS_CONFIG, value);
        return this;
    }

    public KafkaProducerPropertiesBuilder RECONNECT_BACKOFF_MS(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder REQUEST_TIMEOUT_MS(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder RETRIES(int value) {
        properties.put(RETRIES_CONFIG, value);
        return this;
    }

    public KafkaProducerPropertiesBuilder RETRY_BACKOFF_MS(Object value) {
        properties.put(RETRY_BACKOFF_MS_CONFIG, value);
        return this;
    }

    public KafkaProducerPropertiesBuilder SEND_BUFFER(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder TRANSACTIONAL_ID(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder TRANSACTION_TIMEOUT(Object value) {
     ...
     * @return {@link KafkaProducerPropertiesBuilder}
     */
    public KafkaProducerPropertiesBuilder VALUE_SERIALIZER_CLASS(String cls) {
