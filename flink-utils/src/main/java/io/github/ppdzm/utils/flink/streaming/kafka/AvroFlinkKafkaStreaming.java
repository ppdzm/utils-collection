...
@NoArgsConstructor
public abstract class AvroFlinkKafkaStreaming<T> extends FlinkKafkaStreaming<T> {
    /**
     * [[Schema]]
     */
...
//    public AvroFlinkKafkaStreaming(String applicationName,
//                              Alerter alerter,
...
//    }
    ...
    public AvroFlinkKafkaStreaming(AvroFlinkKafkaStreamingConfig streamingConfig,
                                   Alerter alerter,
                                   Schema schema,
                                   String schemaRegistryUrl,
                                   int identityMapCapacity,
        ...
        this.identityMapCapacity = identityMapCapacity;
        this.recordClazz = recordClazz;
        this.schemaCoderProvider = new CachedSchemaCoderProvider("", schemaRegistryUrl, identityMapCapacity);
    }

    FlinkKafkaConsumer<T> getFlinkKafkaConsumer() throws Exception {
