...
public abstract class AvroRecordKafkaStreaming extends AvroKafkaStreaming<GenericRecord> {

//    public AvroRecordKafkaStreaming(String applicationName,
//                                    Alerter alerter,
...
//    }
    ...
    public AvroRecordKafkaStreaming(AvroKafkaStreamingConfig streamingConfig,
                                    Alerter alerter,
                                    Schema schema,
                                    String schemaRegistryUrl,
